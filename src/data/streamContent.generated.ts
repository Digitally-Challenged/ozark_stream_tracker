...
export const streamContent: StreamContentMap = {
  ...
  'falls-br': {
    ...
    description:
      'Falls Branch runs class III to V, which is to say it runs hard when it runs at all. The kind of water where things can go sideways in a hurry and you better have the skills to deal with it.\n\nNot much else written down about this one. Some creeks keep their secrets.',
    sections: [],
    accessPoints: [
      {
        name: 'Put-in',
  ...
  'fern-gulley': {
    ...
    description:
      "Fern Gulley. The name sounds gentle, but the water isn't. Class IV-V means you're in the deep end of the pool, where mistakes cost more than they should and the creek doesn't offer much forgiveness.\n\nWhat else there is to know, well, that's between you and whoever's run it before.",
    sections: [],
    accessPoints: [
      {
        name: 'Put-in',
  ...
  'little-mill-cr': {
    ...
    description:
      "Little Mill Creek runs Class III to IV, and so do its tributaries - West Fork and Middle Fork both come in technical and steep. This is a creek system for paddlers who've put in their years, who know the difference between confident and cocky.\n\nThree forks of advanced whitewater braiding through the same drainage. The Ozarks have a way of hiding water like this in the folds of the hills, waiting for someone skilled enough to find it.",
    sections: [],
    accessPoints: [
      {
        name: 'Put-in',
  ...
  'mormon-cr': {
    ...
    description:
      "Mormon Creek runs hard, class IV pushing to IV+ when it's up. This is expert water that asks for clean lines and good judgment, the kind of creek where you'll scout more than once and be glad you did. It doesn't advertise much, but the paddlers who know it treat it with respect.",
    sections: [],
    accessPoints: [
      {
        name: 'Put-in',
  ...
  'spirits-cr': {
    ...
    description:
      "Spirits Creek carries class III water through country that hasn't given up many of its details to the record books. What's known is the difficulty rating, and that's enough - solid intermediate creek water when it's running.",
    sections: [],
    accessPoints: [
      {
        name: 'Put-in',
  ...
  'upper-upper-shoal-cr': {
    ...
    description:
      "When regular Shoal Creek isn't quite enough, there's the Upper section. When Upper Shoal isn't quite enough, there's this - the headwaters run, where the creek's still gathering its strength but already knows how to use it. Class III+ through tight quarters.\n\nIt's like climbing higher up the holler to find where the spring starts. More effort to get there, but you're seeing the creek before it smooths out and settles down.",
    sections: [],
    accessPoints: [
      {
        name: 'Put-in',

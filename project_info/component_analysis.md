...
_(This analysis will be expanded with more components and details as the project progresses, including props interfaces, state management, side effects, dependencies, and AI bloat indicators for each.)_

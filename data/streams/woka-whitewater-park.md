...
**Rating:** PLAY
**Watershed Size:** A (Always available)
...
### Eight Whitewater Drops

- **Character:** Engineered wave and hole features
- **Skill Levels:** Features for beginners through advanced
- **Notes:** Real river conditions, not a theme park

### Side Channel Design

- **Character:** Diverts flow from main Illinois River
- **Features:** Consistent flows when river is running
- **Notes:** 100 feet wide, 1,200 feet long

## Access & Facilities

### Location

**Address:** Watts, Oklahoma (near AR/OK border)
**Nearby:** Siloam Springs, Arkansas

### Amenities

- Day parking ($10, cashless only)
- Seasonal rentals (kayaks, tubes)
- Shop and concessions (seasonal)
...
8 AM - 5 PM (check website for seasonal closures)

### Contact

- Phone: 918-610-WOKA (9652)
- Email: woka@grda.com
- Website: visitwoka.com
...
**Primary Gauge:** Illinois R. nr Siloam Springs (07195430)
**Optimal Range:** 2.0-6.0 ft
**Notes:** Park operates when Illinois River has adequate flow

## Sources

- [Visit WOKA](https://visitwoka.com/)

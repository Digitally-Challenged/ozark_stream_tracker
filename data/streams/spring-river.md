...
- Spring-fed clarity and cold water
- Consistent flows year-round
- Gravel bars
- Scenic bluffs in sections
...
## Gauge Information
**Notes:** Spring-fed nature provides more consistent flows than rainfall-dependent streams
...
**Note:** Due to licensing and accessibility constraints, direct public domain/Creative Commons images of the Spring River in Arkansas are limited. The following resources contain images that may be available for use:

### Wikimedia Commons Resources
- [Category:Mammoth Spring State Park](https://commons.wikimedia.org/wiki/Category:Mammoth_Spring_State_Park) - Contains 18 files including historical photos and dam images
- [Category:Mammoth Spring](https://commons.wikimedia.org/wiki/Category:Mammoth_Spring) - Contains 4 files including "Mammoth Springs Dam in the Afternoon.jpg" (4,000 × 3,000)
- [File:Mammoth Spring near average.JPG](https://commons.wikimedia.org/wiki/File:Mammoth_Spring_near_average.JPG) - Shows Mammoth Spring near average flow conditions
- Historical image: "Spring River, Hardy, Ark" from NYPL collection (NYPL b12647398-74425) available via Wikimedia Commons

### Additional Image Sources
- [NYPL Digital Collections](https://digitalcollections.nypl.org/) - Search for "Spring River Hardy Arkansas" for historical photographs
- [Arkansas Game and Fish Commission](https://www.agfc.com/) - May have public use photos (contact press room)
- [Encyclopedia of Arkansas - Spring River](https://encyclopediaofarkansas.net/entries/spring-river-5375/) - Contains contextual photos
- [TripAdvisor Spring River Photos](https://www.tripadvisor.com/Attraction_Review-g28925-d209751-Reviews-Spring_River-Arkansas.html) - User-submitted photos (check individual licenses)

For direct use in publications, visit the Wikimedia Commons links above to download images with proper licensing information. All Wikimedia Commons content is freely licensed for reuse.
